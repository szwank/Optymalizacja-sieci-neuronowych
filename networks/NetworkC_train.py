    ...
    for zbior in range(5):
        ...
        class rysuj(keras.callbacks.Callback):
            ...
            def on_epoch_end(self, epoch, logs={}):
                ...
                text_file=open('../models/Network C/ess'+str(ess)+'/zbior'+str(zbior)+'_uczenie.txt','a')
        ...
        filepath="../models/Network C/ess"+str(ess)+"/fold"+str(zbior)+"_epoch_"+"{epoch:02d}"+"_val_loss_"+"{val_loss:.4f}"+"_val_acc_"+"{val_acc:.3f}"
