...
for ess in range(1,7):
    for zbior in range(5):
        ...
        #
        model=Sequential()
        model.add(Convolution2D(64,3,3,border_mode='same' , init='glorot_normal',W_regularizer=l2(reg), input_shape=(3,size,size)))
        ...
        class rysuj(keras.callbacks.Callback):
            ...
            def on_epoch_end(self, epoch, logs={}):
                ...
                text_file=open('../models/Network E/ess'+str(ess)+'/zbior'+str(zbior)+'_uczenie.txt','a')
        ...
        filepath="../models/Network E/ess"+str(ess)+"/fold"+str(zbior)+"_epoch_"+"{epoch:02d}"+"_val_loss_"+"{val_loss:.4f}"+"_val_acc_"+"{val_acc:.3f}"
