...
for ess in range(1,7):
    for zbior in range(5):
        ...
        model=VGG16(include_top=False,input_tensor=input_tensor,weights=None)
        ...
        class rysuj(keras.callbacks.Callback):
            ...
            def on_epoch_end(self, epoch, logs={}):
                ...
                text_file=open('../models/Network F/ess'+str(ess)+'/zbior'+str(zbior)+'_uczenie.txt','a')
        ...
        filepath="../models/Network F/ess"+str(ess)+"/fold"+str(zbior)+"_epoch_"+"{epoch:02d}"+"_val_loss_"+"{val_loss:.4f}"+"_val_acc_"+"{val_acc:.3f}"
