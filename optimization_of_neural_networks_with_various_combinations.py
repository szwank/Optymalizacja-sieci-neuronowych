...
def main():
    ...
    for zbior in range(4, 5):
        ...
        path_to_assesing_file_full_layers = os.path.join('Network scores', model_hash)
        path_to_assesing_file_single_filters = os.path.join('Network scores', model_hash + 'v2')
