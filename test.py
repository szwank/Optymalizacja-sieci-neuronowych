...
def tran_VGG16_on_CIFAR10(batch_size=128, learning_rate=0.1):
    ...
    original_network = CreateNN.test(0.0001)
    ...
    # Callback
    learning_rate_regulation = keras.callbacks.ReduceLROnPlateau(monitor='loss', factor=0.1, patience=7, verbose=1,
    ...
    earlyStopping = keras.callbacks.EarlyStopping(monitor='val_loss', patience=15,
                                                  restore_best_weights=True)  # zatrzymanie uczenia sieci jeżeli
